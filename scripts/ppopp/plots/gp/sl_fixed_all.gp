...
set output "eps/fig10_sl_all.eps"
...
plot \
     @FILE0 using 1:(column_select(NCOL0lf)) title @LINE0lf ls 6 with linespoints, \
...
set title @PLOT1
plot \
     @FILE1 using 1:(column_select(NCOL0lf)) title @LINE0lf ls 6 with linespoints, \
     "" using 1:(column_select(NCOL0)) title @LINE0 ls 1 with linespoints, \
     "" using 1:(column_select(NCOL1)) title @LINE1 ls 2 with linespoints, \
     "" using 1:(column_select(NCOL2)) title @LINE2 ls 3 with linespoints, \
     "" using 1:(column_select(NCOL3)) title @LINE3 ls 4 with linespoints
...
unset ylabel
plot \
     @FILE3 using 1:(column_select(NCOL0lf)) title @LINE0lf ls 6 with linespoints, \
     "" using 1:(column_select(NCOL0)) title @LINE0 ls 1 with linespoints, \
     "" using 1:(column_select(NCOL1)) title @LINE1 ls 2 with linespoints, \
     "" using 1:(column_select(NCOL2)) title @LINE2 ls 3 with linespoints, \
     "" using 1:(column_select(NCOL3)) title @LINE3 ls 4 with linespoints
...
set key spacing 1.5
set key horiz
set key at screen 1.3, screen 0.65 center top
