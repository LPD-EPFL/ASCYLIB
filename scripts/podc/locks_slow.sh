...
INIT=one make SLOW=1 WSTATS=1 wf_tests
...
range=`echo "${i} * 2" | bc`
echo "1%Updates 10%Updates 50%Updates" >> ./data/locks_slow_ll.txt
thrs=""
devs=""
for u in ${updates}; do
...
echo $thrs >> ./data/locks_slow_ll.txt
echo $devs >> ./data/locks_slow_ll.txt
done

for i in ${initials}; do
range=`echo "${i} * 2" | bc`
echo "1%Updates 10%Updates 50%Updates" >> ./data/locks_slow_sl.txt
thrs=""
devs=""
for u in ${updates}; do
...
echo $thrs >> ./data/locks_slow_sl.txt
echo $devs >> ./data/locks_slow_sl.txt
done

for i in ${initials}; do
range=`echo "${i} * 2" | bc`
echo "1%Updates 10%Updates 50%Updates" >> ./data/locks_slow_ht.txt
thrs=""
devs=""
for u in ${updates}; do
...
echo $thrs >> ./data/locks_slow_ht.txt
echo $devs >> ./data/locks_slow_ht.txt
done

for i in ${initials}; do
range=`echo "${i} * 2" | bc`
echo "1%Updates 10%Updates 50%Updates" >> ./data/locks_slow_bst.txt
thrs=""
devs=""
for u in ${updates}; do
...
echo $thrs >> ./data/locks_slow_bst.txt
echo $devs >> ./data/locks_slow_bst.txt
done
