...
pr  -m -t $tmp_get_suc $tmp_get_fal $tmp_put_suc $tmp_put_fal $tmp_rem_suc $tmp_rem_fal | awk 'NF' > $tmp_p8;
...
pr  -m -t $tmp_get_suc $tmp_get_fal $tmp_put_suc $tmp_put_fal $tmp_rem_suc $tmp_rem_fal | awk 'NF' > $tmp_p9;


paste $tmp_p1  $tmp_p2  $tmp_p3  $tmp_p4  $tmp_p5  $tmp_p6  $tmp_p7  $tmp_p8 $tmp_p9 | column -t;
