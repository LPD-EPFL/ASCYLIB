...
BENCHS = src/linkedlist src/linkedlist-harris_opt src/linkedlist-michael src/hashtable-harris src/hashtable-rcu src/hashtable-java src/hashtable-copy src/hashtable-tbb src/skiplist src/skiplist-fraser src/skiplist-herlihy_lf src/skiplist-seq src/skiplist-herlihy_lb src/skiplist-pugh src/skiplist-string-pugh src/bst-ellen src/bst-seq_internal src/bst-howley src/bst-aravind src/noise/ src/tests/ src/bst-tk/
...
LFBENCHS = src/linkedlist src/linkedlist-harris_opt src/linkedlist-michael src/hashtable-harris src/hashtable-rcu src/skiplist src/skiplist-fraser src/skiplist-herlihy_lf src/bst-ellen src/bst-howley src/bst-aravind
