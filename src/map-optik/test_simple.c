...
#define DS_CONTAINS(s,k,t)  map_contains_l(s, k)
#define DS_ADD(s,k,t)       map_add_l(s, k, k)
#define DS_REMOVE(s,k,t)    map_remove_l(s, k)
#define DS_SIZE(s)          map_size_l(s)
#define DS_NEW(size)        map_new_l(size)

#define DS_TYPE             map_t
#define DS_NODE             key_val_t
