...
#define DS_CONTAINS(s,k,t)  pqueue_contains(s, k)
#define DS_ADD(s,k,t)       pqueue_add(s, k, t)
#define DS_REMOVE(s)        pqueue_remove(s)
#define DS_SIZE(s)          pqueue_size(s)
#define DS_NEW(nthr)        pqueue_new(nthr)

#define DS_TYPE             pqueue_t
...
extern __thread size_t __pq_thread_id;
